...
// 配点は全1,048,576通りの総当たりで出現率を測りながら調整してある。
// (最大12.2% / 最小4.8%、武士が最レアになるよう意図的に加点機会を絞っている)
export const QUESTIONS = [
  ...
  },
  {
    ...
    choices: [
      ...
      { id: 'q2b', text: 'うまく笑って誤魔化す', scores: { sarugakushi: 2, hokashi: 1 } },
      { id: 'q2c', text: '堂々と名乗り、正当な理由を主張する', scores: { yamabushi: 2, bushi: 1 } },
  ...
  },
  {
    ...
    text: '休息日の過ごし方は?',
    choices: [
      { id: 'q4a', text: '一人静かに瞑想・修行する', scores: { yamabushi: 2, shukke: 1 } },
      { id: 'q4b', text: '街に出て人と交流し、噂話を集める', scores: { akindo: 2, sarugakushi: 1 } },
      { id: 'q4c', text: '薬草を摘み、体調を整える', scores: { kusuriya: 2, kusushi: 1 } },
      { id: 'q4d', text: '芸や新しい技を磨く', scores: { sarugakushi: 2, hokashi: 1 } },
    ],
  },
  {
    id: 'q5',
    ...
    choices: [
      ...
      { id: 'q5c', text: '人を騙すこと', scores: { shukke: 2, bushi: 1 } },
  ...
  },
  {
    ...
    choices: [
      ...
      { id: 'q7c', text: '執着を捨て、心を平らかに保つ', scores: { komuso: 2, shukke: 1 } },
      { id: 'q7d', text: '人との縁と信頼を大事にする', scores: { akindo: 2, kusuriya: 1 } },
    ],
  },
  {
    id: 'q8',
  ...
  },
  {
    ...
    choices: [
      ...
      { id: 'q10b', text: '「技」―― 技巧を極める', scores: { sarugakushi: 2, hokashi: 1 } },
      { id: 'q10c', text: '「誠」―― 誠実に向き合う', scores: { shukke: 2, bushi: 1 } },
