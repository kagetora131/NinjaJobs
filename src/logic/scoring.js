 ...
 *
 * 武士(bushi)・虚無僧(komuso)・薬師(kusushi)の選択肢は、武士の選択肢が各+2
 * (2026/9/20の平等化調整までは武士だけ+1だった)、虚無僧・薬師の器用貧乏枠Dが
 * 両者に+2。素直に「同点は問3→問1でタイブレーク」を武士にも適用すると、
 ...
 * のみ(2026/9/20時点の配点では、武士の選択肢を複数回選んだ場合がほとんどで、
 * 全体では約3.8%で12タイプ中もっともレア)。同点に武士が含まれる場合は
